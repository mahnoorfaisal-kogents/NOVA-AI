...
export const PLAN_LIMITS: Record<PlanTier, PlanLimits> = {
  free: {
    ...
    max_agents: 3,
    max_automations: 2,
    allowed_models: ['nova-fast', 'nova-standard', 'nova-local'],
    coding: false,
    research: false,
    data_analysis: false,
    voice: false,
  ...
  pro: {
    ...
    max_agents: 15,
    max_automations: 25,
    allowed_models: ['nova-fast', 'nova-standard', 'nova-local', 'nova-reasoning', 'nova-coding', 'nova-research'],
    coding: true,
    research: true,
    data_analysis: true,
    voice: true,
  ...
  ultimate: {
    ...
    max_automations: 100,
    allowed_models: [
      'nova-fast', 'nova-standard', 'nova-reasoning', 'nova-coding',
      'nova-research', 'nova-vision', 'nova-long-context', 'nova-multimodal', 'nova-local',
    ],
    coding: true,
    research: true,
    data_analysis: true,
